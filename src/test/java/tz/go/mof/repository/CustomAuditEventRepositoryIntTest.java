package tz.go.mof.repository;

import tz.go.mof.GatewayApp;
import tz.go.mof.config.Constants;
import tz.go.mof.config.audit.AuditEventConverter;
import tz.go.mof.domain.PersistentAuditEvent;
...
import static tz.go.mof.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
